...
The accuracy curve is essentially flat at high values from the very first layer, peaking at 0.990 at layer 7.

![Linear probe accuracy across encoder layers. Chance is 0.5.](/images/ml/probe-accuracy-vs-depth.png)

Across all layers, probe accuracy is 0.975–0.990, with no warm-up period — the distinction is present from layer 0 and stays there. The best layer (layer 7) achieves 0.990; the earliest layers are already above 0.975. The model encodes the speech/non-speech distinction strongly across the full depth of the encoder.
