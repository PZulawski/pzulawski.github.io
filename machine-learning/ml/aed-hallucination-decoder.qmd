...
|---|---|---|
| *I just...* | 0.50 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-01.wav" type="audio/wav"></audio> |
| *Right here.* | 0.50 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-02.wav" type="audio/wav"></audio> |
| *about it.* | 0.25 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-03.wav" type="audio/wav"></audio> |
| *I don't know why I always just.* | 0.27 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-04.wav" type="audio/wav"></audio> |
| *Well, and, um...* | 0.29 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-05.wav" type="audio/wav"></audio> |
| *Any* | 0.50 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-06.wav" type="audio/wav"></audio> |
| *And Janet, what the...* | 0.56 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-07.wav" type="audio/wav"></audio> |
| *Oh.* | 0.33 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-08.wav" type="audio/wav"></audio> |
| *We are taking.* | 0.40 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-09.wav" type="audio/wav"></audio> |
| *That's what you get.* | 0.25 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-10.wav" type="audio/wav"></audio> |
| *Uh,* | 0.00 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-11.wav" type="audio/wav"></audio> |
| *Thank you.* | 0.50 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fn-12.wav" type="audio/wav"></audio> |
...
| Model output | Hallucinated token fraction | |
|---|---|---|
| *Thank you.* | 0.75 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-04.wav" type="audio/wav"></audio> |
| *Thank you.* | 0.75 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-16.wav" type="audio/wav"></audio> |
| *Yeah.* | 0.67 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-10.wav" type="audio/wav"></audio> |
...
| Model output | Hallucinated token fraction | |
|---|---|---|
| *Dance dance to the baby* | 1.00 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-18.wav" type="audio/wav"></audio> |
| *I'm not gonna do it!* | 1.00 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-02.wav" type="audio/wav"></audio> |
| *Jump!* | 1.00 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-21.wav" type="audio/wav"></audio> |
| *Get him up!* | 1.00 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-06.wav" type="audio/wav"></audio> |
| *WHAT THEY ARE?!* | 0.92 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-13.wav" type="audio/wav"></audio> |
| *Your top tower is under attack.* | 0.89 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-12.wav" type="audio/wav"></audio> |
| *Take a picture of that.* | 0.86 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-11.wav" type="audio/wav"></audio> |
| *Get on the truck, let's go! F***ing normies! Eat this!* | 0.77 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-01.wav" type="audio/wav"></audio> |
| *We'll be right back.* | 0.75 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-03.wav" type="audio/wav"></audio> |
| *I hit one of them, 40 white. His dude died on air by the other team.* | 0.71 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-07.wav" type="audio/wav"></audio> |
| *Come on* | 0.67 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-05.wav" type="audio/wav"></audio> |
| *So here he is, you can see the...* | 0.64 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-23.wav" type="audio/wav"></audio> |
| *Nope, I have not.* | 0.62 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-15.wav" type="audio/wav"></audio> |
| *And then it's flying fire.* | 0.60 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-14.wav" type="audio/wav"></audio> |
| *Quick hands.* | 0.60 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-19.wav" type="audio/wav"></audio> |
| *I'm gonna go see* | 0.57 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-20.wav" type="audio/wav"></audio> |
| *Aw, stop it. If you guys like this video and you guys want to watch me try more fun Halloween hacks, I have a whole playlist.* | 0.57 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-22.wav" type="audio/wav"></audio> |
| *Sometimes you say, you hear it?* | 0.56 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-09.wav" type="audio/wav"></audio> |
| *That feels like a tight fit.* | 0.50 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-08.wav" type="audio/wav"></audio> |
| *So* | 0.50 | <audio controls style="height:1.4em;width:160px"><source src="/audio/ml/fp-17.wav" type="audio/wav"></audio> |
...
The probe, trained on the single question of hallucination versus normal transcription and nothing else, achieves very strong separation on held-out data. This gives a rough upper bound on the hallucination suppression a modified training procedure could achieve by better coupling the model's internal hallucination signal to its output decision - a kind of speed-of-light estimate for what this architecture and data are capable of.
