...
| Model output | Hallu token fraction |
|---|---|
| *Thank you.* | 0.75 |
| *Thank you.* | 0.75 |
| *Yeah.* | 0.67 |
...
The second group are genuine probe errors, where real speech is present but in a form the probe has not encountered during training — synthetic or effects-processed game voices, song lyrics in background music, speech with heavy ambient noise or reverberation:
